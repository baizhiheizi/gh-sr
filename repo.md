...
Packages and coverage (2026-06-06):

- `internal/agentic` 60.5% — agentic-workflow prereq validators
...
Maintainer (an-lee) merges test-improver PRs regularly (PRs #11, #31, #34, #40, #51, #54, #58, #68 all merged). [[commands]] [[testing-notes]] [[backlog]] [[wip]]
